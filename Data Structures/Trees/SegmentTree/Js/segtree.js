(function (exports) {
  ...
  SegmentTree.prototype.query = function (start, end) {
    ...
    var findEl = function (originalArrayStart, originalArrayEnd, current) 
    {
      ...
      if (start === originalArrayStart && end === originalArrayEnd || originalArrayStart === originalArrayEnd) 
      {
        return this._data[current];
      }
      var originalArrayMid = Math.floor((originalArrayStart + originalArrayEnd) / 2);
